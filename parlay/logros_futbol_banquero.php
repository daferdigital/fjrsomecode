   	  ...
   	  <table width="100%" cellspacing="0" cellpadding="4" class="logros_tabla">
            	...
            	<tr valign="bottom">
                	<td width="200"><label class="tit_campos"><strong>Visitante:</strong></label><br /><?php $atributos="name=\'lvisitante\' id=\'lvisitante\' required=\'required\'"; genera_select("select idequipo,nombre from equipos where idliga='".$_REQUEST['liga']."' order by nombre",' name="visitante" id="visitante" disabled="disabled" required="required" onchange=""');?></td>
                        ...
                        <td class="td_left"><label class="tit_campos">Empate JC</label></td><td><input type="text" name="idapuesta49" id="idapuesta49" value="" size="4" /></td>
                </tr>
                <tr valign="bottom" class="">
                	<td><label class="tit_campos">Ref.:</label><br /><input type="text" value="" disabled="disabled" name="referenciaA" id="referenciaA" size="3" maxlength="4" required="required" />
                    	</td>
                        ...
                        <td class="td_left"><label class="tit_campos">Empate MJ</label></td><td><input type="text" name="idapuesta50" id="idapuesta50" value="" size="4" /></td>
                </tr>
                <tr valign="bottom" bgcolor="#ebebeb">
                	<td class="linesep"><label class="tit_campos"><strong>Home Club:</strong></label><br /><?php $atributos="name=\'lhome\' id=\'lhome\' required=\'required\'"; genera_select("select idequipo,nombre from equipos where idliga='".$_REQUEST['liga']."'  order by nombre",' name="home" id="home" disabled="disabled" required="required" onchange=""');?></td>
                        ...
                        <td bgcolor="#FFFFFF" class="td_left linesep"><label class="tit_campos">Goles JC</label></td><td bgcolor="#FFFFFF" class="linesep"><input type="text" name="idapuesta52" id="idapuesta52" value="" size="4" /></td>
                </tr>
                <tr valign="top" bgcolor="#ebebeb" class="">
                	<td><label class="tit_campos">Ref.:</label><br /><input type="text" value="" disabled="disabled" name="referenciaB" id="referenciaB" size="3" maxlength="4" required="required" />
                    	</td>
                        <td align="center"><label class="tit_campos">Logro<br />
                        ...
                        <td bgcolor="#FFFFFF" class="td_left"><label class="tit_campos">Goles MJ</label></td><td bgcolor="#FFFFFF"><input type="text" name="idapuesta53" id="idapuesta53" value="" size="4" /></td>
                </tr>
            </table>
   	  </td></tr>
    		<tr>
...
jQuery(document).ready(function(){
	...
	//$('[name="idapuesta79"]').numeric(false, function() { alert("Integers only"); this.value = ""; this.focus(); });idapuesta53
