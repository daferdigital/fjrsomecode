...
class GanadoresFutbol {
	...
	public static $FUTBOL_A_GANAR_JC_A = 19;
	public static $FUTBOL_A_GANAR_JC_B = 21;
	public static $FUTBOL_A_GANAR_MJ_A = 20;
	public static $FUTBOL_A_GANAR_MJ_B = 22;
	...
	public static $FUTBOL_EMPATE_JC = 49;
	public static $FUTBOL_EMPATE_MJ = 50;
	...
	public static function calcularGanador($rowVistaVentasDetalles){
		...
		} else if($rowVistaVentasDetalles["idcategoria_apuesta"] == GanadoresFutbol::$FUTBOL_A_GANAR_JC_A
				|| $rowVistaVentasDetalles["idcategoria_apuesta"] == GanadoresFutbol::$FUTBOL_A_GANAR_JC_B){
			// es A GANAR JUEGO COMPLETO FUTBOL
			$codeReturn = GanadoresFutbol::checkAGanarJuegoCompleto($rowVistaVentasDetalles);
		} else if($rowVistaVentasDetalles["idcategoria_apuesta"] == GanadoresFutbol::$FUTBOL_A_GANAR_MJ_A
				|| $rowVistaVentasDetalles["idcategoria_apuesta"] == GanadoresFutbol::$FUTBOL_A_GANAR_MJ_B){
			// es A GANAR MEDIO JUEGO FUTBOL
			$codeReturn = GanadoresFutbol::checkAGanarMedioJuego($rowVistaVentasDetalles);
		} else if($rowVistaVentasDetalles["idcategoria_apuesta"] == GanadoresFutbol::$FUTBOL_EMPATE_MJ){
			// es EMPATE MEDIO JUEGO FUTBOL
			$codeReturn = GanadoresFutbol::checkEmpateMedioJuego($rowVistaVentasDetalles);
		} else if($rowVistaVentasDetalles["idcategoria_apuesta"] == GanadoresFutbol::$FUTBOL_EMPATE_JC){
			// es EMPATE MEDIO JUEGO FUTBOL
