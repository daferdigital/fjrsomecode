...
<table width="100%">
    ...
    <td>Suspendido</td>
                                ...
                                <td align="center"><input class="numeric" type="text" name="resultado[<?Php echo $idlogro_equipoA;?>][15]2" value="<?Php echo $resA[15];?>" size="2" maxlength="2" /></td>
                                ...
                                <td rowspan="2" align="center"><select name="resultado[<?Php echo $idlogro_equipoA;?>][14]2">
                                  <option value="0">Opcional</option>
                                  <option <?Php echo($resA[14]==1?'selected="selected"':'');?> value="1">Suspendido</option>
                                </select></td>
                                ...
                                <td rowspan="2" align="center"><select name="resultado[<?Php echo $idlogro_equipoA;?>][13]">
                                  <option value="">Opcional</option>
                                  <option <?Php echo($resA[13]==1?'selected="selected"':'');?> value="1">Suspendido</option>
                                </select></td>
                                </tr>
                                <tr class="" bgcolor="<?Php echo $color;?>">
                            	
                                <td><?php echo $equipoB.$referenciaB; ?></td>
                                <td align="center"><input class="numeric" type="text" name="resultado[<?Php echo $idlogro_equipoB;?>][16]2" value="<?Php echo $resB[16];?>" size="2" maxlength="2" /></td>
...
<div align="center"><input type="button" name="guardar" value="Guardar" class="boton" onclick="javascript: form_resultados='futbol.php';comentario='cualquiera'; nolistado='no'; noreset='no'; validar(document.form1,'resultados.php');" /></div>
<input type="hidden" name="resultado_categoria" value="futbol" />
</form>
