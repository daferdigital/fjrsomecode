...
<table width="100%">
	<tr class="titulo_tablas"><td height="30" colspan="11" align="center">Cargar resultados para el Día <?Php echo $_GET['fecha'];?></td></tr>
	...
	<?Php
	  ...
	  <td colspan="4" bgcolor="#0033FF">Primeros 5 inning</td>
    </tr>
    ...
    <td>Suspendido</td>
                                ...
                                <td align="center"><input class="numeric" type="text" name="resultado[<?Php echo $idlogro_equipoA;?>][4]2" value="<?Php echo $resA[4];?>" size="2" maxlength="2" /></td>
                                <td align="center"><input class="numeric" type="text" name="resultado[<?Php echo $idlogro_equipoA;?>][11]2" value="<?Php echo $resA[11];?>" size="2" maxlength="2" /></td>
                                ...
                                <td rowspan="2" align="center"><select name="resultado[<?Php echo $idlogro_equipoA;?>][6]2">
                                  <option value="0">Opcional</option>
                                  <option <?Php echo($resA[6]==1?'selected="selected"':'');?> value="1">Suspendido</option>
                                </select></td>
                                ...
                                <td rowspan="2" align="center"><select name="resultado[<?Php echo $idlogro_equipoA;?>][3]">
                                  <option value="">Opcional</option>
                                  <option <?Php echo($resA[3]==1?'selected="selected"':'');?> value="1">Suspendido</option>
                                </select></td>
                                </tr>
                                <tr class="" bgcolor="<?Php echo $color;?>">
                            	
                                <td><?php echo $equipoB.'<br>'.$pitcherB['nombre'].' ('.$pitcherB['lado'].')'.$referenciaB; ?></td>
                                <td align="center"><input class="numeric" type="text" name="resultado[<?Php echo $idlogro_equipoB;?>][5]2" value="<?Php echo $resB[5];?>" size="2" maxlength="2" /></td>
                                <td align="center"><input class="numeric" type="text" name="resultado[<?Php echo $idlogro_equipoB;?>][12]2" value="<?Php echo $resB[12];?>" size="2" maxlength="2" /></td>
                                ...
                                <td align="center"><input class="numeric" type="text" name="resultado[<?Php echo $idlogro_equipoB;?>][2]2" value="<?Php echo $resB[2];?>" size="2" maxlength="2" /></td>
                                </tr>
    ...
    <td>Suspendido</td>
                    ...
                    <tr class="" bgcolor="<?Php echo $color;?>">
                                ...
                                <input type="hidden" name="estatus_<?Php echo $idlogro_equipoB;?>" value="<?Php echo $estatus['estatus'];?>" />
                                </td>
                                <td><?php echo $equipoA.'<br>'.$pitcherA['nombre'].' ('.$pitcherA['lado'].')'.$referenciaA; ?></td>
                                ...
                                <td align="center"><input class="numeric" type="text" name="resultado[<?Php echo $idlogro_equipoA;?>][9]" value="<?Php echo $resA[9];?>" size="2" maxlength="2" /></td>
                                <td rowspan="2" align="center"><select name="resultado[<?Php echo $idlogro_equipoA;?>][6]">
                                  <option value="0">Opcional</option>
                                  <option <?Php echo($resA[6]==1?'selected="selected"':'');?> value="1">Suspendido</option>
                                </select></td>
                                ...
                                <td rowspan="2" align="center"><select name="resultado[<?Php echo $idlogro_equipoA;?>][3]2">
                                  <option value="">Opcional</option>
                                  <option <?Php echo($resA[3]==1?'selected="selected"':'');?> value="1">Suspendido</option>
                                </select></td>
                                </tr>
...
<div align="center"><input type="button" name="guardar" value="Guardar" class="boton" onclick="javascript: form_resultados='beisbol.php';comentario='cualquiera'; nolistado='no'; noreset='no'; validar(document.form1,'resultados.php');" /></div>
