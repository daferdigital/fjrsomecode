	...
	<table width="" align="left" cellpadding="4px" cellspacing="0">
        ...
        <tr>
   	  ...
   	  <table width="100%" cellspacing="0" cellpadding="4" class="logros_tabla">
            	...
            	<tr valign="bottom">
                	<td width="200"><label class="tit_campos"><strong>Visitante:</strong></label><br /><?php  $atributos="name=\'lvisitante\' id=\'lvisitante\' required=\'required\'"; genera_select("select idequipo,nombre from equipos where idliga='".$_REQUEST['liga']."'",' name="visitante" id="visitante" required="required" ');
					...
					/*$atributos="name=\'lvisitante\' id=\'lvisitante\' required=\'required\'"; genera_select("select idequipo,nombre from vista_equipos where idliga='".$_REQUEST['liga']."' or otras_ligas like '%|".$_REQUEST['liga']."|%' order by nombre",' name="visitante" id="visitante" required="required" onchange=""'); */?></td>
                        ...
                        <td align="center" width="40" class="td_left"><label class="tit_campos">A JC</label></td><td><input type="text" name="idapuesta102" id="idapuesta102" value="" size="4" /></td>
                        <td class="td_left">Empate JC</td><td><input type="text" name="idapuesta106" id="idapuesta106" value="" size="4" /></td>
                </tr>
                ...
                <tr valign="bottom" bgcolor="#ebebeb">
                	<td class="linesep"><label class="tit_campos"><strong>Home Club:</strong></label><br /><?php $atributos="name=\'lhome\' id=\'lhome\' required=\'required\'"; genera_select("select idequipo,nombre from equipos where idliga='".$_REQUEST['liga']."'",' name="home" id="home" required="required" ');/* $atributos="name=\'lhome\' id=\'lhome\' required=\'required\'"; genera_select("select idequipo,nombre from vista_equipos where idliga='".$_REQUEST['liga']."' or otras_ligas like '%|".$_REQUEST['liga']."|%'  order by nombre",' name="home" id="home" required="required" onchange=""'); */?></td>
                        ...
                        <td bgcolor="#FFFFFF" class="td_left linesep">Goles JC</td><td bgcolor="#FFFFFF" class="linesep"><input type="text" name="idapuesta109" id="idapuesta109" value="" size="4" /></td>
                </tr>
                <tr valign="top" bgcolor="#ebebeb" class="">
                	<td><label class="tit_campos">Ref.:</label><br /><input type="text" value="" name="referenciaB" id="referenciaB" size="3" maxlength="4" required="required" />
                        ...
                        <td bgcolor="#FFFFFF" class="td_left">Goles MJ</td><td bgcolor="#FFFFFF"><input type="text" name="idapuesta110" id="idapuesta110" value="" size="4" /></td>
                </tr>
            </table>
