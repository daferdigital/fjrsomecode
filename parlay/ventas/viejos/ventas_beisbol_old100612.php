...
<div>
<strong>Monto de la apuesta:</strong> <input type="text" name="monto_apuesta" id="monto_apuesta" class="numeric" onkeyup="javascript: calcular_monto_pagar();" required size="5" maxlength="6" value="0" style="text-align: right;" />
