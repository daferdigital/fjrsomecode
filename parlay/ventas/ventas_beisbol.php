				...
				$equipoA='';$equipoB='';$bandera=''; $categoria=$apuestas_permitidas_todas=$apuestas_permitidas='';
					while($varlogros=mysql_fetch_assoc($querylogros)){
						...
						if($bandera==''){
							...
							if($nombre_liga==''){
								$nombre_liga=$varlogros['nombre_liga'];								
							}
						...
						if($categoria!=$varlogros['idliga']){
							...
							genera_encabezado('encabezado',$varlogros['idliga'],$varlogros['nombre_categoria']);//tabla de encabezados
						}
						...
						genera_encabezado('items_ventas',$varlogros['idliga'],$deporte='');
