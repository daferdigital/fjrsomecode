...
<div align="center"><strong>Desde:</strong> <input type="text" name="fdesde" id="fdesde" readonly="readonly" value="<?Php echo $fecha_desde;?>" class="fecha" style="cursor:pointer;" /> <strong>Hasta:</strong> <input type="text" name="fhasta" id="fhasta" readonly="readonly" value="<?Php echo $fecha_hasta;?>" class="fecha" style="cursor:pointer;" /> <input type="button" class="boton" id="carga_formulario" value="Buscar" /></div>
<div id="rep_dinamico">
...
<script type="text/javascript">
	$(document).ready(function() {
		   ...
		   $("#carga_formulario").click(function(evento){
			  ...
			  $("#rep_dinamico").load("reportes/reporte_1.php?fdesde="+$("#fdesde").val()+"&fhasta="+$("#fhasta").val(), function(response, status, xhr){
				  if (status == "error") {
