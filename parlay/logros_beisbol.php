	...
	<table width="" align="" cellpadding="4px" cellspacing="0">
        ...
        <tr>
   	  ...
   	  <table width="" cellspacing="0" cellpadding="4" class="logros_tabla">
            	...
            	<tr valign="bottom">
                	<td width="200px"><label class="tit_campos"><strong>Visitante:</strong></label><br /><?php $atributos="name=\'lvisitante\' id=\'lvisitante\' required=\'required\'"; genera_select("select idequipo,nombre from equipos where idliga='".$_REQUEST['liga']."' order by nombre",' name="visitante" id="visitante" required="required" onchange="dinamico_select(\'dinvisitante\',this.value,\''.$array_lanzadores.'\',\''.$atributos.'\')"');?></td>
          ...
          <td class="td_left">
                ...
                <tr valign="bottom" bgcolor="" class="linesep">
                  <td class=""><label class="tit_campos">Ref.:</label><br /><input type="text" value="" name="referenciaA" id="referenciaA" size="3" maxlength="4" required="required" /></td>
                  <td align="center" class="td_left"><label class="tit_campos">Logro<br />
                          6to:</label></td>
                ...
                <tr valign="top" bgcolor="#ebebeb">
                	<td class="linesep"><label class="tit_campos"><strong>Home Club:</strong></label><br /><?php $atributos="name=\'lhome\' id=\'lhome\' required=\'required\'"; genera_select("select idequipo,nombre from equipos where idliga='".$_REQUEST['liga']."'  order by nombre",' name="home" id="home" required="required" onchange="dinamico_select(\'dinhome\',this.value,\''.$array_lanzadores.'\',\''.$atributos.'\')"');?></td>
                ...
                <tr valign="bottom" bgcolor="#ebebeb" class="linesep">
                  <td class=""><label class="tit_campos">Ref.:</label><br /><input type="text" value="" name="referenciaB" id="referenciaB" size="3" maxlength="4" required="required" /></td>
                  <td align="center"  class="td_left"><label class="tit_campos">Logro<br />
                          6to:</label></td>
...
jQuery(document).ready(function(){
	...
	$('[name="idapuesta79"],[name="idapuesta36"],[name="idapuesta35"],[name="idapuesta70"]').numeric({ negative: false }, function() {  this.value = ""; this.focus(); });
