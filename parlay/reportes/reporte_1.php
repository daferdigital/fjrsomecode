...
if($nivel_muestra=='1'){
	...
	do{
      ...
      <tr>
        ...
        <td>
			<a class="ajax_reporte" href="reportes/reporte_1.php?idbanquero=<? echo $row["idbanquero"]?>&fdesde=<?Php echo $_GET['fdesde'];?>&fhasta=<?Php echo $_GET['fhasta'];?>">
				<strong><? echo $row["nombres"]." ".$row["apellidos"];?></strong>
			</a>
        </td>
        <td bgcolor="#66FF33"><div align="right"><? echo number_format($ventas, 2, '.', '');?> Bs.</div></td>
        <td><div align="right"><? echo number_format($ventas_parlay, 2, '.', '');?> Bs.</div></td>
        <td><div align="right"><? if($ventas_derecho<='0'){echo "0";}else{echo number_format($ventas_derecho, 2, '.', '');}?> Bs.</div></td>
        <td><div align="right"><? if($premios>='1'){echo number_format($premios, 2, '.', '');}else{ echo "0";} ?> Bs.</div></td>
        <td><div align="right"><? if($devolucion>='1'){echo number_format($devolucion, 2, '.', '');}else{ echo "0";} ?> Bs.</div></td>
        <td><? $saldo=($ventas-$premios-$devolucion);?><div align="right" <? if($saldo<0){echo "style='color: #F00;'";}?>><? echo number_format($saldo, 2, '.', '');?> Bs.</div></td>
      </tr><?
      ...
      <tr>
        ...
        <div align="right" <? if($totalSaldo<0){echo "style='color: #F00;'";}?>>
        	<strong><? echo number_format($totalSaldo, 2, '.', '');?> Bs.</strong>
        </div>
        </td>
      </tr><?
	}?>
	...
	do{
      ...
      <tr>
        ...
        <td> <div align="right"><? echo number_format($ventas_parlay, 2, '.', '');?> Bs.</div></td>
        <td> <div align="right">
          <? if($ventas_derecho<='0'){echo "0";}else{echo number_format($ventas_derecho, 2, '.', '');}?> Bs.</div></td>
