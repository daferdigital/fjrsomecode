...
$usuario="ingenier_fix";
	...
	function genera_encabezado($que_muestro,$categoria,$deporte=''){
		...
		///switch($idliga){
			...
			if($idliga=='4' or $idliga=='5' or $idliga=='7' or ($idliga>=12 && $idliga<=15) or $idliga=='17' or ($idliga>=20 && $idliga<=28) or ($idliga>=30 && $idliga<=43) ){
				///Futbol ///padre=1

				include ("deportes_est/futbol.php");
				
			}else if($idliga=='16' or $idliga=='18' or $idliga=='47'){ //Basket ///padre=3
				include ("deportes_est/basket.php");
			}

			else if($idliga=='11' or $idliga=='3' or $idliga=='1' or $idliga=='44' or $idliga=='45'){ //Beisbol ///padre=2
				include ("deportes_est/beisbol.php");
			}

			else if($idliga=='10'){ //Futbol AMERICANO ///padre=6
