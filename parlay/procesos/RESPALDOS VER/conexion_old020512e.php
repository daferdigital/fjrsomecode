<?Php
	...
	return $array;
	  ...
	  function setea_tickets($equipoA,$equipoB){
		  mysql_query("update vista_ventas_detalles set ganador=0, perdedor=0, reembolsar=0 where (idlogro_equipo='".$equipoA."' or idlogro_equipo='".$equipoB."') and reembolsado='0' and pagado='0' and anulado='0' and vencido='0'"); //SETEA LOS VALORES DE GANADOR Y PERDEDOR		  
	  }
				...
				elseif($que_muestro=='ventas'):	
					?>
                    	...
                    	<tr class="borde_rigth_bottom_top"  bgcolor="<?Php echo $color;?>"> 
                            ...
                            <td><?Php echo $refA; ?></td>
                            <td align="right"><?php echo $array_datos[19][1]; ?><input type="checkbox" combinacion="l<?Php echo $varlogros['idlogro'].'_19';?>" pago="<?php echo $array_datos[19][1]; ?>" name="apuesta[]" value="<?php echo $array_datos[19][2] ?>" /></td>
                            <td align="left"><input type="checkbox" combinacion="l<?Php echo $varlogros['idlogro'].'_20';?>" pago="<?php echo $array_datos[20][1] ?>" name="apuesta[]" value="<?php echo $array_datos[20][2] ?>" /><?php echo $array_datos[20][1] ?></td>
                            <td align="center"><?php echo ($array_datos[16][0]>0?'&nbsp;'.$array_datos[16][0]:$array_datos[16][0]).' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_16" pago="'.$array_datos[16][1].'" name="apuesta[]" value="'.$array_datos[16][2].'" /> '.$array_datos[16][1]; ?></td><!--<td align="center"><?php echo ($array_datos[18][0]>0?'&nbsp;'.$array_datos[18][0]:$array_datos[18][0]).' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_18" pago="'.$array_datos[18][1].'" name="apuesta[]" value="'.$array_datos[18][2].'" /> '.$array_datos[18][1] ?></td>-->
                            <td rowspan="2" align="center"><?php echo 'A '.$array_datos[41][1].' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_41" pago="'.$array_datos[41][1].'" name="apuesta[]" value="'.$array_datos[41][2].'" /> ('.$array_datos[52][1].')<br>B '.$array_datos[42][1].' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_42" pago="'.$array_datos[42][1].'" name="apuesta[]" value="'.$array_datos[42][2].'" /> ('.$array_datos[52][1].')'; ?></td>
                            <td rowspan="2" align="center"><?php echo 'A '.$array_datos[43][1].' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_43" pago="'.$array_datos[43][1].'" name="apuesta[]" value="'.$array_datos[43][2].'" /> ('.$array_datos[53][1].')<br>B '.$array_datos[44][1].' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_44" pago="'.$array_datos[44][1].'" name="apuesta[]" value="'.$array_datos[44][2].'" /> ('.$array_datos[53][1].')'; ?></td>
                            <td rowspan="2" align="right"><?php echo $array_datos[49][1].' (JC) <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_49" pago="'.$array_datos[49][1].'" name="apuesta[]" value="'.$array_datos[49][2].'" /><br>'.$array_datos[50][1].' (MJ) <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_50" pago="'.$array_datos[50][1].'" name="apuesta[]" value="'.$array_datos[50][2].'" />' ?></td>
                        </tr>
                        <tr class="borde_rigth_bottom" bgcolor="<?Php echo $color;?>">
                            ...
                            <td><?Php echo $refB; ?></td>
                            <td align="right"><?php echo $array_datos[21][1] ?><input type="checkbox" combinacion="l<?Php echo $varlogros['idlogro'].'_21';?>" pago="<?php echo $array_datos[21][1] ?>" name="apuesta[]" value="<?php echo $array_datos[21][2] ?>" /></td>
                            <td align="left"><input type="checkbox" combinacion="l<?Php echo $varlogros['idlogro'].'_22';?>" pago="<?php echo $array_datos[22][1] ?>" name="apuesta[]" value="<?php echo $array_datos[22][2] ?>" /><?php echo $array_datos[22][1] ?></td>
                            <td align="center"><?php echo ($array_datos[17][0]>0?'&nbsp;'.$array_datos[17][0]:$array_datos[17][0]).' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_17" pago="'.$array_datos[17][1].'" name="apuesta[]" value="'.$array_datos[17][2].'" /> '.$array_datos[17][1]; ?></td><!--<td align="center"><?php echo ($array_datos[51][0]>0?'&nbsp;'.$array_datos[51][0]:$array_datos[51][0]).' <input type="checkbox" pago="'.$array_datos[51][1].'" name="apuesta[]" value="'.$array_datos[51][2].'" /> '.$array_datos[51][1]; ?></td>-->
                        </tr>
                            <tr><td colspan="9">&nbsp;</td></tr>
                    <?Php
				...
				elseif($que_muestro=='impresion'):
					?>
                    	...
                    	<tr align="center" class="borde_rigth_bottom_top"  bgcolor="<?Php echo $color;?>">
                            ...
                            <td align=""><?php echo $array_datos[56][1] ?></td>
                            <td align=""><?php echo $array_datos[57][1] ?></td>
                            <td align=""><?php echo $array_datos[82][1] ?></td>
                            <td align=""><?php echo $array_datos[86][1] ?></td>
                            <td align=""><?php echo $array_datos[88][1] ?></td>
                            <td align=""><?php echo $array_datos[90][1] ?></td>
                            
                            <td align="center"><?php echo ($array_datos[60][0]>0?'&nbsp;'.$array_datos[60][0]:$array_datos[60][0]).'  '.$array_datos[60][1]; ?></td>
                            <td align="center"><?php echo ($array_datos[62][0]>0?'&nbsp;'.$array_datos[62][0]:$array_datos[62][0]).'  '.$array_datos[62][1] ?></td>
                            <td align="center"><?php echo ($array_datos[84][0]>0?'&nbsp;'.$array_datos[84][0]:$array_datos[84][0]).'  '.$array_datos[84][1] ?></td>
                            
                            <td rowspan="2" align="center"><?php echo 'A '.$array_datos[64][1].'  ('.$array_datos[68][1].')<br>B '.$array_datos[65][1].'  ('.$array_datos[68][1].')'; ?></td>
                            <td rowspan="2" align="center"><?php echo 'A '.$array_datos[66][1].'  ('.$array_datos[69][1].')<br>B '.$array_datos[67][1].'  ('.$array_datos[69][1].')'; ?></td>
                            <td rowspan="2" align="center"><?php echo 'A '.$array_datos[92][1].'  ('.$array_datos[94][1].')<br>B '.$array_datos[93][1].'  ('.$array_datos[94][1].')'; ?></td>
                        </tr>
                        <tr class="borde_rigth_bottom" align="center" bgcolor="<?Php echo $color;?>">
                            ...
                            <td align=""><?php echo $array_datos[58][1] ?></td>
                            <td align=""><?php echo $array_datos[59][1] ?></td>
                            <td align=""><?php echo $array_datos[83][1] ?></td>
                            <td align=""><?php echo $array_datos[87][1] ?></td>
                            <td align=""><?php echo $array_datos[89][1] ?></td>
                            <td align=""><?php echo $array_datos[91][1] ?></td>
                            
                            <td align="center"><?php echo ($array_datos[61][0]>0?'&nbsp;'.$array_datos[61][0]:$array_datos[61][0]).'  '.$array_datos[61][1]; ?></td>
                            <td align="center"><?php echo ($array_datos[63][0]>0?'&nbsp;'.$array_datos[63][0]:$array_datos[63][0]).'  '.$array_datos[63][1]; ?></td>
                            <td align="center"><?php echo ($array_datos[85][0]>0?'&nbsp;'.$array_datos[85][0]:$array_datos[85][0]).'  '.$array_datos[85][1]; ?></td>
                        </tr>
                        <tr><td colspan="15">&nbsp;</td></tr>
                    <?php
				elseif($que_muestro=='ventas'):	
					?>
                    	...
                    	<tr align="right" class="borde_rigth_bottom_top"  bgcolor="<?Php echo $color;?>">
                            ...
                            <td align="center"><?php echo ($array_datos[60][0]>0?'&nbsp;'.$array_datos[60][0]:$array_datos[60][0]).' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_60" pago="'.$array_datos[60][1].'" name="apuesta[]" value="'.$array_datos[60][2].'" /> '.$array_datos[60][1]; ?></td>
                            <td align="center"><?php echo ($array_datos[62][0]>0?'&nbsp;'.$array_datos[62][0]:$array_datos[62][0]).' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_62" pago="'.$array_datos[62][1].'" name="apuesta[]" value="'.$array_datos[62][2].'" /> '.$array_datos[62][1] ?></td>
                            <td align="center"><?php echo ($array_datos[84][0]>0?'&nbsp;'.$array_datos[84][0]:$array_datos[84][0]).' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_84" pago="'.$array_datos[84][1].'" name="apuesta[]" value="'.$array_datos[84][2].'" /> '.$array_datos[84][1] ?></td>
                            
                            <td rowspan="2" align="center"><?php echo 'A '.$array_datos[64][1].' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_64" pago="'.$array_datos[64][1].'" name="apuesta[]" value="'.$array_datos[64][2].'" /> ('.$array_datos[68][1].')<br>B '.$array_datos[65][1].' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_65" pago="'.$array_datos[65][1].'" name="apuesta[]" value="'.$array_datos[65][2].'" /> ('.$array_datos[68][1].')'; ?></td>
                            <td rowspan="2" align="center"><?php echo 'A '.$array_datos[66][1].' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_66" pago="'.$array_datos[66][1].'" name="apuesta[]" value="'.$array_datos[66][2].'" /> ('.$array_datos[69][1].')<br>B '.$array_datos[67][1].' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_67" pago="'.$array_datos[67][1].'" name="apuesta[]" value="'.$array_datos[67][2].'" /> ('.$array_datos[69][1].')'; ?></td>
                            <td rowspan="2" align="center"><?php echo 'A '.$array_datos[92][1].' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_92" pago="'.$array_datos[92][1].'" name="apuesta[]" value="'.$array_datos[92][2].'" /> ('.$array_datos[94][1].')<br>B '.$array_datos[93][1].' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_93" pago="'.$array_datos[93][1].'" name="apuesta[]" value="'.$array_datos[93][2].'" /> ('.$array_datos[94][1].')'; ?></td>
                        </tr>
                        <tr class="borde_rigth_bottom" align="right" bgcolor="<?Php echo $color;?>">
                            ...
                            <td align="center"><?php echo ($array_datos[61][0]>0?'&nbsp;'.$array_datos[61][0]:$array_datos[61][0]).' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_61" pago="'.$array_datos[61][1].'" name="apuesta[]" value="'.$array_datos[61][2].'" /> '.$array_datos[61][1]; ?></td>
                            <td align="center"><?php echo ($array_datos[63][0]>0?'&nbsp;'.$array_datos[63][0]:$array_datos[63][0]).' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_63" pago="'.$array_datos[63][1].'" name="apuesta[]" value="'.$array_datos[63][2].'" /> '.$array_datos[63][1]; ?></td>
                            <td align="center"><?php echo ($array_datos[85][0]>0?'&nbsp;'.$array_datos[85][0]:$array_datos[85][0]).' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_85" pago="'.$array_datos[85][1].'" name="apuesta[]" value="'.$array_datos[85][2].'" /> '.$array_datos[85][1]; ?></td>
                        </tr>
                        <tr><td colspan="15">&nbsp;</td></tr>
                    <?Php
				elseif($que_muestro=='total_juegos'):
