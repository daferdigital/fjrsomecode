				...
				while($var=mysql_fetch_assoc($query)){
					//if($idventa!=$var['idventa']){
						if($idventa!=$var['idventa']){
							...
							$idventa=$var['idventa'];
							$apuestas=$aciertos=0;
							$evaluar_parley=$idlogroequipoventa='';
						}
			...
			case '3': //Basket
				...
				?>
					<table width="<? echo $ancho;?>" class="ventas_taquilla" border="1" cellspacing="0" cellpadding="3">
						...
						<tr class="titulo_tablas_negro" align="center"><td  width="160px">Equipos</td><td width="25px">Ref.</td>
				...
				elseif($que_muestro=='impresion'):
					?>
                    	<tr class="borde_rigth_bottom_top"  bgcolor="<?Php echo $color;?>">
                            <td colspan="7"><label class="hora_venta"><?php echo '<b>'.$hora.'</b>'; ?></label>
                            </td>
                        </tr>
                    	<tr class="borde_rigth_bottom_top"  bgcolor="<?Php echo $color;?>">
				...
				elseif($que_muestro=='ventas'):	
					?>
                    	...
                    	<tr class="borde_rigth_bottom_top"  bgcolor="<?Php echo $color;?>">                            
                            <td><?php if(file_exists('imagenes/img_equipos/'.$imagenA)){echo '<img align="absmiddle" src="imagenes/img_equipos/'.$imagenA.'">';} echo ' - '.$equipoA; ?></td>
                            <td><?Php echo $refA; ?></td>
                            <td align="right"><?php echo $array_datos[56][1]; ?><input type="checkbox" combinacion="l<?Php echo $varlogros['idlogro'].'_56';?>" pago="<?php echo $array_datos[56][1]; ?>" name="apuesta[]" value="<?php echo $array_datos[56][2] ?>" /></td>
                            <td align="left"><input type="checkbox" combinacion="l<?Php echo $varlogros['idlogro'].'_57';?>" pago="<?php echo $array_datos[57][1] ?>" name="apuesta[]" value="<?php echo $array_datos[57][2] ?>" /><?php echo $array_datos[57][1] ?></td>
                            <td align="center"><?php echo ($array_datos[60][0]>0?'&nbsp;'.$array_datos[60][0]:$array_datos[60][0]).' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_60" pago="'.$array_datos[60][1].'" name="apuesta[]" value="'.$array_datos[60][2].'" /> '.$array_datos[60][1]; ?></td><!--<td align="center"><?php echo ($array_datos[62][0]>0?'&nbsp;'.$array_datos[62][0]:$array_datos[62][0]).' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_62" pago="'.$array_datos[62][1].'" name="apuesta[]" value="'.$array_datos[62][2].'" /> '.$array_datos[62][1] ?></td>-->
                        ...
                        <tr class="borde_rigth_bottom" bgcolor="<?Php echo $color;?>">
                            ...
                            <td><?php if(file_exists('imagenes/img_equipos/'.$imagenB)){echo '<img align="absmiddle" src="imagenes/img_equipos/'.$imagenB.'">';} echo ' - '.$equipoB; ?></td>
                            <td><?Php echo $refB; ?></td>
                            <td align="right"><?php echo $array_datos[58][1] ?><input type="checkbox" combinacion="l<?Php echo $varlogros['idlogro'].'_58';?>" pago="<?php echo $array_datos[58][1] ?>" name="apuesta[]" value="<?php echo $array_datos[58][2] ?>" /></td>
                            <td align="left"><input type="checkbox" combinacion="l<?Php echo $varlogros['idlogro'].'_59';?>" pago="<?php echo $array_datos[59][1] ?>" name="apuesta[]" value="<?php echo $array_datos[59][2] ?>" /><?php echo $array_datos[59][1] ?></td>
                            <td align="center"><?php echo ($array_datos[61][0]>0?'&nbsp;'.$array_datos[61][0]:$array_datos[61][0]).' <input type="checkbox" combinacion="l'.$varlogros['idlogro'].'_61" pago="'.$array_datos[61][1].'" name="apuesta[]" value="'.$array_datos[61][2].'" /> '.$array_datos[61][1]; ?></td><!--<td align="center"><?php echo ($array_datos[63][0]>0?'&nbsp;'.$array_datos[63][0]:$array_datos[63][0]).' <input type="checkbox" pago="'.$array_datos[63][1].'" name="apuesta[]" value="'.$array_datos[63][2].'" /> '.$array_datos[63][1]; ?></td>-->
                        </tr>
                            <tr><td colspan="7">&nbsp;</td></tr>
                    <?Php
				elseif($que_muestro=='total_juegos'):
				?>
                	<tr><td colspan="7" align="right"><b>Total de juegos:</b> <?Php echo $cuenta_juego; $total_juegos=$total_juegos+$cuenta_juego;?></td></tr>                
				<?Php	
				elseif($que_muestro=='items_ventas'):	
						switch($varlogros['idcategoria_apuesta']){							
							//Basket
