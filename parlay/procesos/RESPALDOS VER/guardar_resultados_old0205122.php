		...
		if($imp%2==0):
			...
			/*INICIA FUTBOL****************************************************************************************************************************/
				...
				/***********JUEGO COMPLETO*******************************************************************************************************************/
					...
					//PARA JUEGOS C MONEY LINE
							if($_SESSION['suspendido']>0){genera_aciertos('19',$equipoA);genera_aciertos('21',$equipoB);}
				...
				/***********MEDIO JUEGO*******************************************************************************************************************/
					...
					if($suspendido_todo) $_SESSION['suspendido']=1;
						//PARA MEDIOS JUEGOS MONEY LINE
							if($_SESSION['suspendido']>0){genera_aciertos('20',$equipoA);genera_aciertos('22',$equipoB);}
