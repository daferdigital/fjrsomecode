<?Php
	...
	return $array;
	  ...
	  function setea_tickets($equipoA,$equipoB){
		 ...
		 // mysql_query("update ventas set monto_real_pagar=0, ganador=0, perdedor=0, reembolsar=0, recalculado=0 where idventa IN (select idventa from ventas_detalles where idlogro_equipo_categoria_apuesta_banquero='".$equipoA."' or idlogro_equipo_categoria_apuesta_banquero='".$equipoB."')"); //SETEA LOS VALORES DE GANADOR Y PERDEDOR  
			...
			break;
				...
				elseif($que_muestro=='items_ventas'):	
						switch($varlogros['idcategoria_apuesta']){							
							...
							break;
							case '95': $tp='RL';$equipo_apuesta=$varlogros['nombre_equipo']; $mult=$varlogros['multiplicando'];
							break;
							case '96': $tp='RL';$equipo_apuesta=$varlogros['nombre_equipo']; $mult=$varlogros['multiplicando'];
							break;
