<?Php 
	...
	$numTicket = "";
	if(isset($_GET["numTicket"]) && $_GET["numTicket"] != ""){
		$numTicket = " AND idventa='".$_GET["numTicket"]."'";
	}
...
<div align="center">
	...
	<strong>Nro Ticket:</strong> <input type="text" id="numTicket" name="numTicket" value="<?Php echo $_GET["numTicket"];?>" />
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#contenido_padre").load(
				"tickets_ganadores.php?fdesde="+$("#fdesde").val()
				+"&fhasta="+$("#fhasta").val()
				+"&fil="+$("#fil").val()
				+"&estado="+$("#estado").val()
				+"&numTicket="+$("#numTicket").val(), function(response, status, xhr){
					if (status == "error") {
