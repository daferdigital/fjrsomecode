...
// ----------------------------------------------------------------
$YourEmailAddress = "main_office@franamarlc.com.ve"; 
...
if($post) {
	...
	// Check Name Field
	if(!$name) {
		$error .= 'Por favor, indique su nombre.<br />';
	}
	
	// Checks Email Field
	if(!$email) { 
		$error .= 'Por favor, indique su direccion de correo.<br />';
	}
	if($email && !ValidateEmail($email)) {
		$error .= 'Por favor, indique una direccion de correo valida.<br />';
	}
