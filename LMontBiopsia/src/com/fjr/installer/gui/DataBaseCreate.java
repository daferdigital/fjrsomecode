...
public class DataBaseCreate extends JDialog {
	...
	private JTextField txt1raBiopsia;
	...
	public static void main(String[] args) {
		try {
			DataBaseCreate dialog = new DataBaseCreate();
	...
	public DataBaseCreate() {
		...
		setModal(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage(DataBaseCreate.class.getResource("/resources/images/iconLogo1.jpg")));
		...
		txt1raBiopsia = new JTextField();
		txt1raBiopsia.setColumns(10);
		txt1raBiopsia.setBounds(171, 111, 119, 20);
		contentPanel.add(txt1raBiopsia);
		...
		progressBar.setBounds(85, 141, 262, 19);
	...
	public JTextField getTxt1raBiopsia() {
		return txt1raBiopsia;
	}
