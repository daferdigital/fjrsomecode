...
public class BarcodeTest {
     ...
     * @throws    IOException
     */
    public void createPdfFJR(String filename) throws IOException, DocumentException {
    	// step 1
        //Document document = new Document(new Rectangle(340, 842));
    	//factor 2.8 en la dimension en mm al rectangulo
    	 Document document = new Document(new Rectangle(162, 125), 10, 10, 10, 10);
        // step 2
        ...
        Image imgFJR = codeEAN.createImageWithBarcode(cb, null, null);
        imgFJR.setRotationDegrees(90F);
        //document.add(imgFJR);
        p.add(new Chunk("Texto del parrafo"));
        p.add(new Chunk(imgFJR, 20F, -70F));
        document.add(p);
