...
import com.fjr.code.gui.tables.JTableEntregaBiopsia;
 ...
 *
 */
public class EntregaBiopsiaPanel extends JPanel implements ActionListener{
	/**
	 * 
	 */
	 ...
	 * Create the panel.
	 */
	public EntregaBiopsiaPanel(boolean entregaMaterial) {
		...
		if(ACTION_COMMAND_BUSCAR.equals(e.getActionCommand())){
			...
			if(results == null 
				...
				AppWindow.getInstance().setPanelContenido(null, 
						JTableEntregaBiopsia.getNewInstance(results, entregaMaterial).getJTable());
			}
		}
	}
}
