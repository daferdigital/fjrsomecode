...
/**
 * Ventana para controlar la reimpresion o creacion de un informe complementario.
 * 
 * Class: InformeComplementarioDialog <br />
 * DateCreated: 19/03/2014 <br />
 * @author T&T <br />
 *
 */
public class InformeComplementarioDialog extends JDialog implements ActionListener{
	/**
	 * 
	 */
	...
	public InformeComplementarioDialog(String pathToDiagnostico, String codigoBiopsia) {
		...
		setModal(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage(InformeComplementarioDialog.class.getResource("/resources/images/iconLogo1.jpg")));
