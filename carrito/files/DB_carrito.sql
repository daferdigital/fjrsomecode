...
INSERT INTO `perfil` (`id`, `nombre`, `descripcion`) VALUES (1,'Administrador','Usuarios de tipo administrador con permisos superiores en el sistema');
...
CREATE TABLE `venta` (
  ...
  `id_cliente` int(11) NOT NULL COMMENT 'Cliente que genero esta venta',
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `FK_VENTA_CLIENTE` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2013-03-21 15:25:28
