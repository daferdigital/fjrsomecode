<%-- 
    Document   : productos
    Created on : 23/02/2013, 10:40:37 AM
    Author     : Rui
--%>
        ...
        <div id="header">
		  ...
		  <div class="cls"></div>
            ...
            <li><a href="admin.jsp">Resumen</a></li>
                ...
                <li><a href="usuarios.jsp" class="Estilo1">Usuarios</a></li>
...
function cambiar_pagina(){
	...
	if(v > 0){
		var arr = new Array('','RegistrarProducto.jsp','ActualizarProducto.jsp','EliminarProducto.jsp')
		location.href = arr[v]
	}else{
...
<p>
  <select id="pedido">
    <option value="0">Seleccione las opcion para el producto (agregar, modificar, eliminar)</option>
    <option value="1">Ingresar o agregar nuevo producto</option>
    <option value="2">Editar o modificar producto</option>
