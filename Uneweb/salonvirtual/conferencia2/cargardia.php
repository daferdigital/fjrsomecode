...
<form action="cargalo.php" method="POST" enctype="multipart/form-data" name="form2" id="form2">
  <label>
  ...
  <table width="1192" border="1" align="center">
    <tr>
      ...
      <td width="921" height="103" align="left">
        ...
        <p>
          <label for="nombre">Nombre de la diapositiva</label>
          <input type="text" name="nombre" id="nombre" />
        </p>
        <p>
          <label for="dia">Imagen</label>
          <input type="file" name="dia" id="dia" />
        </p>
