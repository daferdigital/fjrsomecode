...
INSERT INTO `usuario` (`id`, `cedula`, `nombre`, `apellido`, `telefono`, `direccion`, `email`, `login`, `clave`, `id_perfil`) VALUES (1,'12345678','Administrador','del Sistema','0212-1234567','prueba','admin@carrito.com','admin','e10adc3949ba59abbe56e057f20f883e',1),(3,'878787','uywg','iyh','87','8787','felipe.rojasg@gmail.com','fffffffeeee','e10adc3949ba59abbe56e057f20f883e',2);
...
INSERT INTO `producto` (`id`, `nombre`, `descripcion`, `precio_neto_actual`, `precio_costo_actual`, `id_categoria`, `cantidad_comprada`, `cantidad_vendida`) VALUES (1,'Panetone de Chocolate','Panetone de Chocolate',120,100,5,485,0),(2,'Panetone de Fruta','Panetone de Fruta',120,100,5,484,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=latin1 COMMENT='Sumarizado de las ventas del sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- ORDER BY:  `id_compra`,`id_producto`
...
INSERT INTO `venta_detalle` (`id_venta`, `id_producto`, `cantidad_vendida`, `precio_unitario`, `precio_total`) VALUES (4,1,10,120,1200),(5,2,1,120,120),(6,1,2,120,240),(6,2,3,120,360),(7,1,1,120,120),(7,2,1,120,120),(8,1,1,120,120),(8,2,1,120,120),(9,1,5,120,600),(9,2,5,120,600),(10,1,10,120,1200),(10,2,11,120,1320);
...
--
-- ORDER BY:  `id_usuario`,`id_producto`
...
-- Dump completed on 2013-04-07 20:57:38
