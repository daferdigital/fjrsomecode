...
--
-- Table structure for table `envios_status`
--

DROP TABLE IF EXISTS `envios_status`;
...
INSERT INTO `envios_status` (`id`, `descripcion`) VALUES (1,'Notificado'),(2,'Pago Confirmado'),(3,'Pago No Encontrado'),(4,'Presupuestado'),(5,'Facturado'),(6,'Enviado');
/*!40000 ALTER TABLE `envios_status` ENABLE KEYS */;
UNLOCK TABLES;
