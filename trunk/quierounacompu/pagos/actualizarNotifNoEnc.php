...
<form name="pago" action="updatePayNotifNoEnc.php" method="post" enctype="multipart/form-data">
	...
	<table class="tablaPrincipal" align="center" cellpadding="0" cellspacing="10" width="741">
  		...
  		</tr>		<tr>    		<td colspan="<?php echo $columnas;?>" height="40" align="center" class="isMandatory" style="font-size: 20px;">    			<b>NOTA IMPORTANTE: Datos para realizar la factura fiscal.</b>    		</td>  		</tr>
  		<tr>
  		...
  		<tr>
    		<td class="title Estilo17">
    			* Tus nombres y apellidos &oacute;<br />    			Nombre de la Empresa:
    		</td>
    		<td colspan="<?php echo $columnas - 1?>">
    			<input type="hidden" id="nombre_hidden" name="nombre_hidden" value="<?php echo $envioDTO->getNombreCompleto();?>"/>
  		...
  		<tr>
    		...
    		<td width="266" colspan="<?php echo $columnas - 1?>">
    			<input type="hidden" id="seudonimo_hidden" name="seudonimo_hidden" value="<?php echo $envioDTO->getSeudonimoML();?>"/>
    		...
    		<td class="title Estilo17">
    			* C&eacute;dula de identidad o RIF:
   	 		...
   	 		<td width="270px" colspan="<?php echo $columnas - 1;?>">
      			...
      			<input type="hidden" id="ci_hidden" name="ci_hidden" value="<?php echo $ciCliente[0];?>"/>
      			<input type="hidden" id="cii_hidden" name="cii_hidden" value="<?php echo $ciCliente[1];?>"/>
  		...
  		<tr>
    		...
    		<td>
    			<input type="hidden" id="email_hidden" name="email_hidden" value="<?php echo $envioDTO->getCorreo();?>"/>
  		...
  		<tr>
    		...
    		<td colspan="<?php echo $columnas -1;?>">
    			...
    			<select id="codCelCliente" size="1" name="codCelCliente">
      			...
      			<input type="hidden" id="codCelCliente_hidden" name="codCelCliente_hidden" value="<?php echo $celPhone[0];?>"/>
      			<input type="hidden" id="tlfCelularCliente_hidden" name="tlfCelularCliente_hidden" value="<?php echo $celPhone[1];?>"/>
  		...
  		<tr>
    		...
    		<td colspan="<?php echo $columnas -1;?>">
    			...
    			<input type="hidden" id="codLocalCliente_hidden" name="codLocalCliente_hidden" value="<?php echo $localPhone[0];?>"/>
      			<input type="hidden" id="tlfLocalCliente_hidden" name="tlfLocalCliente_hidden" value="<?php echo $localPhone[1];?>"/>
  		...
  		<tr>
    		...
    		<td colspan="<?php echo $columnas -1;?>">
    			<input type="hidden" id="medio_hidden" name="medio_hidden" value="<?php echo $envioDTO->getIdMedioPago();?>"/>
  		...
  		<tr id="bancoAllInfo" <?php echo ($envioDTO->getIdMedioPago() == 5 ? "style=\"display: none;\"": "");?>>
    		...
    		<td colspan="<?php echo $columnas -1;?>">
    			<input type="hidden" id="banco_hidden" name="banco_hidden" value="<?php echo $envioDTO->getIdBanco();?>"/>
      			<select name="banco" size="1" class="Estilo11" style="FONT-SIZE: 10pt" id="banco">
					<option value="-1" selected>Seleccione su banco</option>
			        <?php
			        	$query = "SELECT id, nombre FROM bancos WHERE active='1' AND show_as_other_banks='0' ORDER BY nombre";
    					$results = DBUtil::executeSelect($query);
    					foreach ($results as $row){    				?>
    						<option value="<?php echo $row["id"];?>" <?php echo ($envioDTO->getIdBanco() == $row["id"] ? "selected" : "");?>>
    							<?php echo $row["nombre"];?>
    						</option>
    				<?php
	    				}
        ...
        <tr id="trBancoOrigen" style="display: none;">
        	...
        	<td colspan="<?php echo $columnas - 1;?>">
        		<input type="hidden" id="bancoOrigen_hidden" name="bancoOrigen_hidden" value="<?php echo $envioDTO->getIdBancoOrigen();?>"/>
        		<select name="bancoOrigen" size="1" class="Estilo11" style="FONT-SIZE: 10pt;" id="bancoOrigen" disabled>
        			<option value="-1" selected>Seleccione su banco</option>
        			<?php
        				$query = "SELECT id, nombre FROM bancos WHERE active='1' AND show_as_other_banks='1' ORDER BY nombre";
        				$results = DBUtil::executeSelect($query);
        				foreach ($results as $row){
					?>
							<option value="<?php echo $row["id"];?>" <?php echo ($envioDTO->getIdBancoOrigen() == $row["id"] ? "selected" : "");?>>
								<?php echo $row["nombre"];?>
							</option>
					<?php
	    				}
  		...
  		<tr>
    		...
    		<td colspan="<?php echo $columnas -1;?>">
    			<input type="hidden" id="bauche_hidden" name="bauche_hidden" value="<?php echo $envioDTO->getNumVoucher();?>"/>
  		...
  		<tr>
    		...
    		<td colspan="<?php echo $columnas -1;?>">
				...
				<input type="hidden" id="fechaPago_hidden" name="fechaPago_hidden" value="<?php echo $fechaPago[2]."-".$fechaPago[1]."-".$fechaPago[0];?>"/>
      	...
      	<tr>
    		...
    		<td colspan="<?php echo $columnas -1;?>">
    			<input type="hidden" id="monto_hidden" name="monto_hidden" value="<?php echo str_replace(".", ",", $envioDTO->getMontoPago());?>"/>
  		...
  		<tr>
    		<td class="title Estilo17" colspan="<?php echo $columnas;?>">
				...
				<input type="hidden" name="articulo_hidden" id="articulo_hidden" value='<?php echo $envioDTO->getDetalleCompra();?>'/>
  		...
  		<tr>
    		...
    		<td colspan="<?php echo $columnas -1;?>">
				...
				<input type="hidden" name="envio_hidden" id="envio_hidden" value='<?php echo $envioDTO->getIdEmpresaEnvio();?>'/>
  		...
  		<tr>
    		...
    		<td colspan="<?php echo $columnas -1;?>">
    			<input type="hidden" name="destinatario_hidden" id="destinatario_hidden" value='<?php echo $envioDTO->getNombreDestinatario();?>'/>
  		...
  		<tr>
    		...
    		<td colspan="<?php echo $columnas -1;?>">
    			...
    			<input type="hidden" name="ciDest_hidden" id="ciDest_hidden" value='<?php echo $ciDest[0];?>'/>
   	 			<input type="hidden" name="ciDestinatario_hidden" id="ciDestinatario_hidden" value='<?php echo $ciDest[1];?>'/>
  		...
  		<tr>
    		...
    		<td colspan="<?php echo $columnas -1;?>">
    			<input type="hidden" name="dir1_hidden" id="dir1_hidden" value='<?php echo $envioDTO->getDireccionDestino();?>'/>
  		...
  		<tr>
    		...
    		<td colspan="<?php echo $columnas -1;?>">
    			<input type="hidden" name="ciudad_hidden" id="ciudad_hidden" value='<?php echo $envioDTO->getCiudadDestino();?>'/>
   		...
   		<tr>
    		...
    		<td colspan="<?php echo $columnas -1;?>">
    			<select name="estado" size="1">
      			...
      			<input type="hidden" name="estado_hidden" id="estado_hidden" value='<?php echo $envioDTO->getEstadoDestino();?>'/>
  		...
  		<tr>
    		...
    		<td colspan="<?php echo $columnas -1;?>">
    			...
    			<select id="codcel" size="1" name="codcel">
      			...
      			<input type="hidden" name="codcel_hidden" id="codcel_hidden" value='<?php echo $celPhone[0];?>'/>
      			<input type="hidden" name="celular_hidden" id="celular_hidden" value='<?php echo $celPhone[1];?>'/>
    	...
    	<tr>
    		...
    		<td colspan="<?php echo $columnas -1;?>">
    			...
    			<input type="hidden" name="codLocalDestinatario_hidden" id="codLocalDestinatario_hidden" value='<?php echo $localPhone[0];?>'/>
      			<input type="hidden" name="tlfLocalDestinatario_hidden" id="tlfLocalDestinatario_hidden" value='<?php echo $localPhone[1];?>'/>
