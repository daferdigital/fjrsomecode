		...
		if($_SESSION['datos']){
			...
			switch($_POST['napuestas']){
				case '1':
					...
					if(($_SESSION['datos']['cmapd']>0)&&($_SESSION['datos']['cmapd']<$_POST['monto_pagar'])){
				...
				break;
				case '2':
					if(($_SESSION['datos']['cma2']>0)&&($_SESSION['datos']['cma2']<$_POST['monto_pagar'])){
				...
				break;
				case '3':
					if(($_SESSION['datos']['cma3']>0)&&($_SESSION['datos']['cma3']<$_POST['monto_pagar'])){
				...
				break;
				case '4':
					if(($_SESSION['datos']['cma4']>0)&&($_SESSION['datos']['cma4']<$_POST['monto_pagar'])){
				...
				break;
				case '5':
					if(($_SESSION['datos']['cma5']>0)&&($_SESSION['datos']['cma5']<$_POST['monto_pagar'])){
				...
				break;
				case '6':
					if(($_SESSION['datos']['cma6']>0)&&($_SESSION['datos']['cma6']<$_POST['monto_pagar'])){
				...
				break;
				case '7':
					if(($_SESSION['datos']['cma7']>0)&&($_SESSION['datos']['cma7']<$_POST['monto_pagar'])){
				...
				break;
				case '8':
					if(($_SESSION['datos']['cma8']>0)&&($_SESSION['datos']['cma8']<$_POST['monto_pagar'])){
				...
				break;
				case '9':
					if(($_SESSION['datos']['cma9']>0)&&($_SESSION['datos']['cma9']<$_POST['monto_pagar'])){
				...
				break;
				case '10':
					if(($_SESSION['datos']['cma10']>0)&&($_SESSION['datos']['cma10']<$_POST['monto_pagar'])){
						$jsondata['mensaje'] = 'La cantidad maxima de apuestas con diez logros ha sido alcanzada';
						$jsondata['vender_ticket'] = 'no';
						$_SESSION['vender']='no';
					}else $par_ley=true;
				break;
