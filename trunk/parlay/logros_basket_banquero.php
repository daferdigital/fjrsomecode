	...
	<table width="" align="left" cellpadding="4px" cellspacing="0">
        ...
        <tr>
   	  ...
   	  <table width="100%" cellspacing="0" cellpadding="4" class="logros_tabla">
            	...
            	<tr valign="bottom">
                	<td width="200"><label class="tit_campos"><strong>Visitante:</strong></label><br /><?php $atributos="name=\'lvisitante\' id=\'lvisitante\' required=\'required\'"; genera_select("select idequipo,nombre from equipos where idliga='".$_REQUEST['liga']."' order by nombre",' name="visitante" id="visitante" disabled="disabled" required="required" onchange=""');?></td>
                        ...
                        <td width="80" valign="top" align="center" class="td_left">
                        	<label class="tit_campos">-</label><input type="radio" value="-2" name="m60" id="idm601" onclick="javascript: document.getElementById('idm612').checked='true';" /><label class="tit_campos">+</label><input type="radio" value="2" name="m60" id="idm602" onclick="javascript: document.getElementById('idm611').checked='true';" /><br />
                        ...
                        <td width="50" valign="bottom" class="td_left" align="center"><label class="tit_campos">1er T.</label></td>
                        <td width="80"><input type="text" name="idapuesta86" id="idapuesta86" value="-110" size="4" /></td>                        
                ...
                <tr valign="bottom" class="">
                	<td class="linesep"><label class="tit_campos">Ref.:</label><br /><input type="text" value="" disabled="disabled" name="referenciaA" id="referenciaA" size="3" maxlength="4" required="required" />
                    	</td>
                        <td align="center" class="linesep td_left"><label class="tit_campos">Logro<br />
                          1M:</label></td><td class="linesep"><input type="text" name="idapuesta57" id="idapuesta57" value="" size="4" /></td>                        
                        
                        <td align="center" class="linesep td_left">
                        	<label class="tit_campos">-</label><input type="radio" value="-2" name="m62" id="idm621" onclick="javascript: document.getElementById('idm632').checked='true';" /><label class="tit_campos">+</label><input type="radio" value="2" name="m62" id="idm622" onclick="javascript: document.getElementById('idm631').checked='true';" /><br /><input type="text" value="" size="3" maxlength="4" name="vm62" id="vm62" onkeyup="javascript:jQuery('#vm63').val(this.value);" />
                            
                            
                        </td><td class="linesep"><input type="text" name="idapuesta62" id="idapuesta62" value="-110" size="4" /></td>
                        <td width="50" valign="bottom" align="center" class="linesep td_left"><label class="tit_campos">2do T.</label></td><td width="80" class="linesep"><input type="text" name="idapuesta88" id="idapuesta88" value="-110" size="4" /></td>
                ...
                <tr valign="bottom" bgcolor="#ebebeb">
                  ...
                  <td align="center" bgcolor="#FFFFFF" class="linesep td_left"><span class="tit_campos">Logro<br />2M</span></td>
                  <td bgcolor="#FFFFFF" class="linesep"><input type="text" name="idapuesta82" id="idapuesta82" value="" size="4" /></td>
                  <td align="center" bgcolor="#FFFFFF" class="linesep td_left">
                  
                  <label class="tit_campos">-</label><input type="radio" value="-2" name="m84" id="idm841" onclick="javascript: document.getElementById('idm852').checked='true';" /><label class="tit_campos">+</label><input type="radio" value="2" name="m84" id="idm842" onclick="javascript: document.getElementById('idm851').checked='true';" /><br /><input type="text" value="" size="3" maxlength="4" name="vm84" id="vm84" onkeyup="javascript:jQuery('#vm85').val(this.value);" />
                  </td>
                  <td valign="bottom" bgcolor="#FFFFFF" class="linesep">
                  <input type="text" name="idapuesta84" id="idapuesta84" value="-110" size="4" /></td>
                  <td width="50" valign="bottom" class="linesep td_left" align="center" bgcolor="#FFFFFF"><label class="tit_campos">3er T.</label></td>
                  <td width="80" bgcolor="#FFFFFF" class="linesep"><input type="text" name="idapuesta90" id="idapuesta90" value="-110" size="4" /></td>
                  ...
                  <td bgcolor="#FFFFFF"><input type="text" name="idapuesta94" id="idapuesta94" value="" size="4" /></td>
          </tr>
                <tr valign="bottom" bgcolor="#ebebeb">
                	<td class="linesep"><label class="tit_campos"><strong>Home Club:</strong></label><br /><?php $atributos="name=\'lhome\' id=\'lhome\' required=\'required\'"; genera_select("select idequipo,nombre from equipos where idliga='".$_REQUEST['liga']."'  order by nombre",' name="home" id="home" required="required" disabled="disabled" onchange=""');?></td>
                        <td align="center" class="linesep td_left"><label class="tit_campos">Logro<br />
                        ...
                        <td class="linesep td_left" align="center">
                        	<label class="tit_campos2">-</label><input type="radio" value="-2" name="m61" id="idm611" onclick="javascript: document.getElementById('idm602').checked='true';"  /><label class="tit_campos2">+</label><input type="radio" value="2" name="m61" id="idm612" onclick="javascript: document.getElementById('idm601').checked='true';"  /><br />
                        ...
                        <td width="50" valign="bottom" align="center" class="linesep td_left"><label class="tit_campos">1er T.</label>
                        </td><td width="80" class="linesep"><input type="text" name="idapuesta87" id="idapuesta87" value="-110" size="4" /></td>
                ...
                <tr valign="bottom" bgcolor="#ebebeb" class="">
                	<td class="linesep"><label class="tit_campos">Ref.:</label><br /><input type="text" disabled="disabled" value="" name="referenciaB" id="referenciaB" size="3" maxlength="4" required="required" />
                    	</td>
                        <td align="center" class="linesep td_left"><label class="tit_campos">Logro<br />
                        1M</label></td><td class="linesep"><input type="text" name="idapuesta59" id="idapuesta59" value="" size="4" /></td>                        
                        
                        <td align="center" class="linesep td_left">
                        	<label class="tit_campos">-</label><input type="radio" value="-2" name="m63" id="idm631" onclick="javascript: document.getElementById('idm622').checked='true';"  /><label class="tit_campos">+</label><input type="radio" value="2" name="m63" id="idm632" onclick="javascript: document.getElementById('idm621').checked='true';"  /><br /><input type="text" value="" size="3" maxlength="4" name="vm63" id="vm63" onkeyup="javascript:jQuery('#vm62').val(this.value);" />
                        </td><td class="linesep"><input type="text" name="idapuesta63" id="idapuesta63" value="-110" size="4" /></td>
                        <td width="50" valign="bottom" align="center" class="linesep td_left"><label class="tit_campos">2do T.</label></td><td width="80" class="linesep"><input type="text" name="idapuesta89" id="idapuesta89" value="-110" size="4" /></td>
                        <td align="center" bgcolor="#FFFFFF" class="td_left linesep"><label class="tit_campos">A 2M</label></td>
                        <td bgcolor="#FFFFFF" class="linesep"><input type="text" name="idapuesta92" id="idapuesta92" value="-110" size="4" /></td>
                ...
                <tr valign="bottom" bgcolor="#ebebeb" class="">
                  ...
                  <td align="center" class="linesep td_left">Logro<br />
                    2M</td>
                  <td class="linesep"><input type="text" name="idapuesta83" id="idapuesta83" value="" size="4" /></td>
                  <td align="center" class="linesep td_left">                  
                  <label class="tit_campos">-</label><input type="radio" value="-2" name="m85" id="idm851" onclick="javascript: document.getElementById('idm842').checked='true';" /><label class="tit_campos">+</label>
                  ...
                  <td class="linesep"><input type="text" name="idapuesta85" id="idapuesta85" value="-110" size="4" /></td>
                  <td width="50" valign="bottom" align="center" class="linesep td_left"><label class="tit_campos">3er T.</label></td><td width="80" class="linesep"><input type="text" name="idapuesta91" id="idapuesta91" value="-110" size="4" /></td>
                  <td align="center" bgcolor="#FFFFFF" class="td_left"><label class="tit_campos">B 2M</label></td>
                  <td bgcolor="#FFFFFF"><input type="text" name="idapuesta93" id="idapuesta93" value="-110" size="4" /></td>
        ...
        <tr><td align="left"><input name="guardar" type="button" class="boton" onClick="javascript:comentario='Complete los campos';validar(document.logros,'logros_banqueros.php');" value="Guardar" /><input name="cancelar" type="reset" class="boton" style=" margin-left:20px;" value="Deshacer" onClick="deshacer(cadena_hiden)" /></td></tr>
    </table>
...
jQuery(document).ready(function(){
	...
	$('#aqui_hora').html('<input type="text" name="hora" disabled="disabled" id="hora" value="<?php echo date("H:i:00"); ?>" required="required" size="5" />');
});
</script>
