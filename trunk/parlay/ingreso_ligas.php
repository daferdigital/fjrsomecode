...
<form name="ligas" method="post" action="procesos/guardar_ligas.php">
	<table width="100%" cellpadding="4px" cellspacing="0">
    	<tr>
        	<td width="50%">
        		<label class="tit_campos">Nombre de la Liga:</label>
        		<input type="text" name="nombre" id="nombre" value="" />
        		<label class="campo_obligatorio">*</label>
        	</td>
    		<td class="color_2colum">
    			<label class="tit_campos">Deporte:</label>
            	<select name="categoria" id="categoria">
					...
					?>
                            <option <?php echo $sel; ?> value="<?php echo $varcategorias['idcategoria']; ?>">
                            	<?php echo $varcategorias['nombre']; ?>
                            </option>               
                	<?Php 
							}//fin while
						}//fin if
        ...
        <tr>
        	<td class="color_2colum">
        		<label class="tit_campos">Orden Visual:</label>
            	<input type="text" name="orden_visual" id="orden_visual" value="0" />
                <label class="campo_obligatorio">* (solo n&uacute;meros)</label>
            </td>
    		<td>
    			&nbsp;
            </td>
        ...
        <tr>
        	<td align="left" colspan="2">
        		<p>Indique a que <strong>Otras Ligas</strong> pertenece el equipo</p>
            	<table width="900" border="1" cellspacing="0" cellpadding="0" align="center">
					...
					?>
						<td colspan="<? echo $columnes;?>" align="center">
							<strong>Indique a que Otras Ligas pertenecen los equipo de esta liga</strong>
						</td>
					<?
						$contador=0;
					...
					?>
					<input type="hidden" name="nregistros" value="<?Php echo $contador;?>" />
					<?Php
						if ($resto <> 0) {
    ...
    <tr>
    	<td align="left" colspan="2">
    		<input name="guardar" type="button" class="boton" onclick="javascript:validar(document.ligas,'ligas.php');" value="Guardar" />
    		<input name="cancelar" type="reset" class="boton" style=" margin-left:20px;" value="Deshacer" onclick="deshacer(cadena_hiden)" />
    	</td>
    </tr>
</table>
