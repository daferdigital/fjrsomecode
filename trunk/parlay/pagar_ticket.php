...
<legend>Indique el código del ticket y el codigo de cobro del ticket a pagar</legend>
<form name="pagar" method="post" action="">
	<table width="100%">
    	<tr><td align="right" width="150px"><label class="tit_campos">Número de Ticket: </label></td><td><input type="text" value="" class="numeric" required="required" name="codigo_ticket" id="codigo_ticket"> <label class="campo_obligatorio">*</label></td></tr>
        <tr><td align="right" width="150px"><label class="tit_campos">Serial de Cobro: </label></td><td><input type="text" value="" class="numeric" required="required" name="codigo_cliente" id="codigo_cliente"> <label class="campo_obligatorio">*</label></td></tr>
