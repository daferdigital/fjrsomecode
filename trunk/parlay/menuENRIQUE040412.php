...
<ul class="sf-menu">
			...
			<li class="current">
				...
				<ul>
                    ...
                    <li>
						<a href="ingreso_combinaciones.php" class="ajax_contenido">Combinaciones</a>
					</li>
					<li>
            ...
            <li>
				<a>Reportes</a>
                 <ul>
                    ...
                    <li><a href="reportes/reporte_mas_apostados.php" class="ajax_contenido">Más apostados</a></li>
                </ul>
			</li>
             <li>
				<a>Mantenimiento</a>
