<?Php //include_once("/procesos/sesiones.php");
	include_once("conexion.php");
		...
		$selectlistado="select *,date_format(fecha,'%d/%m/%Y') as fecha_logro from vista_logros_categorias where fecha='".$ano.'-'.$mes.'-'.$dia."' and idliga='".$_REQUEST['liga']."' group by idlogro ORDER BY hora";
	...
	<?Php
				...
				?><div align="center"><strong>No se han registrado logros para la fecha <?Php echo $_REQUEST['fecha'];?></strong></div><?Php
			}
	?>