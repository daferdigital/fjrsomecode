		...
		if($imp%2==0):
			...
			/*INICIA BASKET****************************************************************************************************************************/			
						...
						//PARA RUNLINE JC
							...
							/*
							}else if($resultado_completo_A>$compara){
								genera_aciertos('60',$equipoA);	
							}else if($resultado_completo_B>$compara){/////($compara>$resultado_completo_B){	
								genera_aciertos('61',$equipoB);
							}*/
							/*
							//	if($multi['multiplicando']>0): //es decir 1.5
						...
						//PARA RUNLINE 1H
							...
							$multi_aleRL=dame_datos("select * from logros_equipos_categorias_apuestas 
													WHERE idlogro_equipo='".$equipoA."' and idcategoria_apuesta='62' 
													limit 1");*/
