...
CREATE TABLE `biopsias` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `codigo_UNIQUE` (`numero`),
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='Tabla maestro de las biopsias realizadas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `biopsias` (`id`, `numero`, `fecha_registro`, `id_examen_biopsia`, `id_cliente`, `id_fase_actual`) VALUES (1,'1268','0000-00-00',1,1,1);
...
-- Dump completed on 2013-09-02  6:36:58
