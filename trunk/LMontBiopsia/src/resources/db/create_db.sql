...
INSERT INTO `fases_biopsia` (`id`, `nombre`) VALUES (1,'Ingreso'),(2,'Macroscopica'),(3,'Histologia'),(4,'Microscopica'),(5,'IHQ'),(6,'Entrega'),(7,'Confirmar IHQ'),(8,'Entregada A Paciente'),(9,'Rechazada Peticion IHQ');
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COMMENT='Tabla maestro de las biopsias realizadas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='pacientes a los que se les realice algun examen de biopsia';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-09-28 17:51:00
