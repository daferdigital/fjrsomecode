...
CREATE TABLE `tipo_examenes` (
  ...
  `activo` char(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tabla de grupos de examenes de biopsias';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tipo_examenes` (`id`, `nombre`, `codigo`, `descripcion`, `activo`) VALUES (-1,'Vacio','000','Vacio','0');
...
INSERT INTO `fases_biopsia` (`id`, `nombre`) VALUES (1,'Ingreso'),(2,'Macroscópica'),(3,'Histología'),(4,'Microscópica'),(5,'IHQ'),(6,'Entrega'),(7,'Confirmar IHQ');
...
INSERT INTO `examenes_biopsias` (`id`, `codigo`, `dias_resultado`, `nombre`, `activo`, `id_tipo_examen`) VALUES (-1,'0000',0,'vacio','0',-1);
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COMMENT='Tabla maestro de las biopsias realizadas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-09-17 10:21:12
