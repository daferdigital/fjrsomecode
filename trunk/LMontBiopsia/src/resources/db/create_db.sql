...
INSERT INTO `patologos` (`id`, `nombre`, `activo`) VALUES (1,'JÃƒÂ©sus Enrique GonzÃƒÂ¡lez Alfonzo','1'),(2,'JosÃƒÂ© David Mota Gamboa','1'),(3,'Enrique LÃƒÂ³pez Loyo','1');
...
INSERT INTO `fases_biopsia` (`id`, `nombre`) VALUES (1,'Ingreso'),(2,'MacroscÃƒÂ³pica'),(3,'HistologÃƒÂ­a'),(4,'MicroscÃƒÂ³pica'),(5,'IHQ'),(6,'Entrega'),(7,'Confirmar IHQ');
...
CREATE TABLE `micro_laminas_ihq_files` (
  ...
  PRIMARY KEY (`id`,`cassete`,`lamina`,`bloque`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- ORDER BY:  `id`,`cassete`,`lamina`,`bloque`
...
INSERT INTO `categorias_reactivos` (`id`, `nombre`) VALUES (1,'Mama'),(2,'Prostata'),(3,'Hipofisis'),(4,'Linfoma'),(5,'ProliferaciÃƒÂ³n'),(6,'Epiteliales'),(7,'Neuroendocrinos'),(8,'Vasculares'),(9,'Musculares'),(10,'Otros');
...
CREATE TABLE `micro_laminas` (
  ...
  `lamina` int(11) NOT NULL,
  `descripcion` text,
  `id_reactivo` int(11) NOT NULL DEFAULT '0',
  `procesado` char(1) NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1 COMMENT='Tabla maestro de las biopsias realizadas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `biopsias` (`id`, `year_biopsia`, `numero_biopsia`, `fecha_registro`, `id_examen_biopsia`, `id_cliente`, `id_fase_actual`) VALUES (4,13,000123,'2013-09-17',-1,-1,1),(5,13,000124,'2013-09-19',1,2,1);
...
INSERT INTO `biopsias_ingresos` (`id`, `procedencia`, `pieza_recibida`, `referido_medico`, `idx`, `id_patologo_turno`) VALUES (5,'prueba','prueba','prueba','prueba',3);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='pacientes a los que se les realice algun examen de biopsia';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cliente` (`id`, `id_premium`, `cedula`, `nombres`, `apellidos`, `edad`, `telefono`, `correo`, `direccion`, `activo`) VALUES (-1,NULL,'0000','vacio','vacio',0,'vacio','vacio','vacio','0'),(1,'11970267','V-11970267','ERNESTO','IBRAIM',30,'',NULL,'LA ALAMEDA BARUTA ','1'),(2,'9656280','V-9656280','GIZEH','PARRA MONTENEGRO',30,'',NULL,'Santa Monica','1');
...
-- Dump completed on 2013-09-19  7:57:03
