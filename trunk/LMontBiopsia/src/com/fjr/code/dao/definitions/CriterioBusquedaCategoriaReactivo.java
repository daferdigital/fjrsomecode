...
/**
 * 
 * Class: CriterioBusquedaCategoriaReactivo
 ...
 *
 */
public enum CriterioBusquedaCategoriaReactivo {
	TODOS("Seleccione"),
	NOMBRE("Nombre"),
	ACTIVO("Activo", false),
	 ...
	 * @param textoDelCombo
	 */
	private CriterioBusquedaCategoriaReactivo(String textoDelCombo) {
	 ...
	 * @param showInCombo
	 */
	private CriterioBusquedaCategoriaReactivo(String textoDelCombo, boolean showInCombo) {
		// TODO Auto-generated constructor stub
