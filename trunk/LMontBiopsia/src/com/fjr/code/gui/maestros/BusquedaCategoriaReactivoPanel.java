 ...
 *
 */
public class BusquedaCategoriaReactivoPanel extends JPanel implements ActionListener{
	/**
	 * 
	 */
	 ...
	 * Create the panel.
	 */
	public BusquedaCategoriaReactivoPanel() {
		setLayout(null);
		...
		CriterioBusquedaCategoriaReactivo[] criterios = CriterioBusquedaCategoriaReactivo.values();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(ACTION_COMMAND_BUSCAR.equals(e.getActionCommand())){
			...
			//y el valor dado
			Map<CriterioBusquedaCategoriaReactivo, String> valores = new HashMap<CriterioBusquedaCategoriaReactivo, String>();
			valores.put((CriterioBusquedaCategoriaReactivo) comboBox1.getSelectedItem(), txtValor1.getText());
			valores.put((CriterioBusquedaCategoriaReactivo) comboBox2.getSelectedItem(), txtValor2.getText());
			
			List<CategoriaReactivoDTO> results = CategoriaReactivoDAO.searchAllByCriteria(valores);
			...
			new CategoriaReactivoDialog(-1).setVisible(true);
		}
	}
}
