...
CREATE TABLE `recibos` (
  ...
  `equivalente_dolar` double DEFAULT NULL,
  `procesado_por` varchar(200) DEFAULT NULL,
  `incluir_mov_bancos` varchar(45) DEFAULT NULL,
  `id_mov_banco` varchar(45) DEFAULT NULL,
  `ref_deposito_banco` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
