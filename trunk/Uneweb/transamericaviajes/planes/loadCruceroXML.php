	...
	<div id="tabs">
		...
		?>
					<div id="tabs-1">
                        	...
                        	<?php 
                        		...
                        		if($filas->length > 0){
                        			foreach ($filas as $fila){
                        				echo "<tr>";
                        				echo "<td>".$fila->getElementsByTagName("dia")->item(0)->nodeValue."</td>";
                        				echo "<td>".$fila->getElementsByTagName("puerto")->item(0)->nodeValue."</td>";
                        				echo "<td>".$fila->getElementsByTagName("llegada")->item(0)->nodeValue."</td>";
                        				echo "<td>".$fila->getElementsByTagName("salida")->item(0)->nodeValue."</td>";
                        				echo "</tr>";
                        			}
                        		}
                        	?>
                        ...
                        <br />
                        <?php 
       						if($seccion->getElementsByTagName("imgNaviera")->item(0)->nodeValue){
						?>
								<hr width="100%" size="2" /> 
								<img src="./img/<?php echo $seccion->getElementsByTagName("imgNaviera")->item(0)->nodeValue?>" />              
                    	<?php 
       						}
                    	?> 
        			</div>
