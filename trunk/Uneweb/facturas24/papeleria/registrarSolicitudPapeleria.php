...
$message .= "<br /> Raz&oacute;n Social: ".$_POST["razonSocial"];
$message .= "<br /> RIF: ".$_POST["rif"];
$message .= "<br /> Contacto: ".$_POST["personaContacto"];
$message .= "<br /> Tel&eacute;fono: ".$_POST["telefonoContacto"];
$message .= "<br /> Correo: ".$_POST["correoContacto"];
$message .= "<br /> Direcci&oacute;n: ".$_POST["direccion"];
$message .= "<br /> Observaciones: ".$_POST["observaciones"];
