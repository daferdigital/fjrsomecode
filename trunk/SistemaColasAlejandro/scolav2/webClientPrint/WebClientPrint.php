...
class Utils{
    ...
    public static function getRoot(){
        ...
        $protocol = Utils::strleft(strtolower($_SERVER["SERVER_PROTOCOL"]), "/").$s;
    ...
    public static function isIE6to9(){
        $ua = Utils::getUA();
        return ((Utils::strContains($ua,"MSIE 6.") ||
                 Utils::strContains($ua,"MSIE 7.") ||
                 Utils::strContains($ua,"MSIE 8.") ||
                 Utils::strContains($ua,"MSIE 9.")) &&
                 Utils::strContains($ua,"Opera") === false);
    }

    public static function isIE5orOlder(){
        $ua = Utils::getUA();
        return ((Utils::strContains($ua,"MSIE 5.") ||
                 Utils::strContains($ua,"MSIE 4.") ||
                 Utils::strContains($ua,"MSIE 3.") ||
                 Utils::strContains($ua,"MSIE 2.")) &&
                 Utils::strContains($ua,"Opera") === false);
    }
        
    public static function isIE10orGreater(){
        $ua = Utils::getUA();
        return (Utils::strContains($ua,"MSIE") || Utils::strContains($ua,"Trident/")) && Utils::isIE6to9() === false && Utils::isIE5orOlder() === false && Utils::strContains($ua,"Opera") === false;
    }
