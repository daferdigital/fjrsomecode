	...
	?>
        	...
        	<tr>
        		<td colspan="2">
        			...
        			<input type="button" value="TRANSFERIR TICKET" border="0" style="cursor:pointer; background-color:#030; color:#CCC; font-weight:bold; padding:3PX; border:#000 2px solid;" onclick="javascript:transferirTicket();" />
                </td>
        	</tr>
        	<tr>
        		<td colspan="2">
