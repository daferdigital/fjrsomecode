...
INSERT INTO `banco` (`id`, `nombre`, `activo`) VALUES (1,'Banco Mercantil','1'),(2,'Banco de Venezuela','1'),(3,'Banesco','1');
...
INSERT INTO `carrito_tmp` (`id_usuario`, `id_producto`) VALUES (1,2);
...
INSERT INTO `perfil` (`id`, `nombre`, `descripcion`) VALUES (1,'Administrador','Usuarios de tipo administrador con permisos superiores en el sistema'),(2,'Cliente','Usuarios tipo cliente');
...
INSERT INTO `producto` (`id`, `nombre`, `descripcion`, `precio_neto_actual`, `precio_costo_actual`, `id_categoria`, `cantidad_comprada`, `cantidad_vendida`) VALUES (1,'Panetone de Chocolate','Panetone de Chocolate',120,100,5,472,471),(2,'Panetone de Fruta','Panetone de Fruta',120,100,5,473,0);
...
INSERT INTO `tipo_de_pago` (`id`, `descripcion`) VALUES (1,'Pago con Tarjeta de crédito'),(3,'Cheque');
...
CREATE TABLE `usuario` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tipo_identidad` char(1) NOT NULL,
...
INSERT INTO `usuario` (`id`, `tipo_identidad`, `cedula`, `nombre`, `apellido`, `telefono`, `direccion`, `email`, `login`, `clave`, `id_perfil`) VALUES (1,'V','12345678','Administrador','del Sistema','0212-1234567','prueba','felipe.rojasg@gmail.com','admin','e10adc3949ba59abbe56e057f20f883e',1),(3,'E','878787','uywg','iyh','87','8787','felipe.rojasg@gmail.com','fffffffeeee','e10adc3949ba59abbe56e057f20f883e',2),(4,'V','876876','iuwhfeiuh','IUHIUH','876987987','gvg kjnompom ugbuy','felipe.rojasg@gmail.com','frooooo','e10adc3949ba59abbe56e057f20f883e',2);
...
CREATE TABLE `venta` (
  ...
  `nro_documento_pago` varchar(45) NOT NULL COMMENT 'numero del documento de pago, cheque, tarjeta, etc',
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=latin1 COMMENT='Sumarizado de las ventas del sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `venta` (`id`, `fecha`, `monto_sin_iva`, `iva`, `cod_factura`, `nro_documento_pago`, `id_usuario`, `id_banco`, `id_tipo_pago`) VALUES (4,'2013-04-07 15:17:54',1032,168.00000000000003,NULL,'73568735678643',1,2,3),(5,'2013-04-07 15:31:25',103.2,16.8,NULL,'12345612345',1,2,3),(6,'2013-04-07 15:39:25',516,84.00000000000001,NULL,'12345612345',1,2,3),(7,'2013-04-07 15:43:59',206.4,33.6,NULL,'892375983275987982739',1,2,3),(8,'2013-04-07 15:44:33',206.4,33.6,NULL,'',1,2,3),(9,'2013-04-07 15:50:44',1032,168.00000000000003,NULL,'333333333333333',1,2,3),(10,'2013-04-07 16:13:11',2167.2,352.8,NULL,'23678326487632',1,2,3),(11,'2013-04-08 10:34:56',2167.2,352.8,NULL,'37486587346',1,2,3),(12,'2013-04-08 10:54:07',103.2,16.8,NULL,'3333333333333333',1,2,3),(13,'2013-04-10 14:50:18',103.2,16.8,NULL,'8726492846987209374',1,3,1),(14,'2013-04-11 12:01:10',103.2,16.8,NULL,'33333333',1,2,3),(15,'2013-04-11 13:12:49',103.2,16.8,NULL,'2222222222222',1,2,3);
...
INSERT INTO `venta_detalle` (`id_venta`, `id_producto`, `cantidad_vendida`, `precio_unitario`, `precio_total`) VALUES (4,1,10,120,1200),(5,2,1,120,120),(6,1,2,120,240),(6,2,3,120,360),(7,1,1,120,120),(7,2,1,120,120),(8,1,1,120,120),(8,2,1,120,120),(9,1,5,120,600),(9,2,5,120,600),(10,1,10,120,1200),(10,2,11,120,1320),(11,1,10,120,1200),(11,2,11,120,1320),(12,1,1,120,120),(13,1,1,120,120),(14,1,1,120,120),(15,1,1,120,120);
...
-- Dump completed on 2013-04-11 17:24:01
